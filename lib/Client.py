...
class Client(object):
    ...
    def __init__(self, name='toto', logger=None) :
        ...
        self.kbytes_ps = -1.0                     # Number of Kbytes per seconds targetted
        ...
        self.dx_script       = None         # a script to convert the data of a senderAm
        ...
        for line in config.readlines():
            ...
            if (len(words) >= 2 and not re.compile('^[ \t]*#').search(line)):
                try:
                    ...
                    elif words[0] == 'kbytes_ps': self.kbytes_ps = int(words[1]) + 0.0
    ...
    def printInfos(self, client):
        ...
        print("Kbytes_ps: %s" %  client.kbytes_ps)
