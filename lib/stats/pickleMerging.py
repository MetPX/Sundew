...
def mergePicklesFromSameHour( logger = None , pickleNames = None, mergedPickleName = "", clientName = "" , combinedMachineName = "", currentTime ="" ):
    """
            This methods receives a list of filenames referring t/apps/px/lib/o 
